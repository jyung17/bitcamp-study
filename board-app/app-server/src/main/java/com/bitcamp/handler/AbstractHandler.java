...
public abstract class AbstractHandler implements Handler {
  ...
  protected void printMenus(PrintWriter out) throws Exception {
  ...
  protected static void printHeadline(PrintWriter out) throws Exception {
    out.println("=========================================");
  }

  protected static void printBlankLine(PrintWriter out) throws Exception {
