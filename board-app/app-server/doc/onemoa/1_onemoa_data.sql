...
-- 주문 상태 테이블
insert into order_status (scno, name) value(1, '결제완료'); 
insert into order_status (scno, name) value(2, '제작중'); 
insert into order_status (scno, name) value(3, '발송중'); 
insert into order_status (scno, name) value(4, '발송완료'); 
insert into order_status (scno, name) value(5, '주문취소'); 
