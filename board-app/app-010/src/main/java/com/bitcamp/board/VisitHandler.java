...
public class VisitHandler {
    ...
    while (true) {
      ...
      switch (menuNo) {
        case 0:
          return;
        case 1:
          VisitHandler.processList();
          break;
        case 2:
          VisitHandler.processDetail();
          break;
        case 3:
          VisitHandler.processInput();
          break;
        case 4:
          VisitHandler.processDelete();
          break;
        case 5:
          VisitHandler.processUpdate();
          break;
        default:
  ...
  static void processDelete() {
    ...
    int boardNo = Prompt.inputInt("삭제할 방명록 번호? ");
    int boardIndex = -1;
    for (int i = 0; i < boardCount; i++) {
      if (boards[i].no == boardNo) {
        boardIndex = i;
