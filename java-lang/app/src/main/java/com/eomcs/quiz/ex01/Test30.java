...
//
/*
 * There are N houses in a village on a circular road numbered from 1 to N starting from some house
 * in clockwise order. It takes one minute to get from one house to any of two adjacent houses and
 * there are no other roads in this village besides the circular one. Find the minimal time required
 ...
 * visitsOnCircularRoad(4, [1, 3, 2, 3, 1]) = 6
 * 
 * [input] integer N number of houses, positive integer
 * 
