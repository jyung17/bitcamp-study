...
//
/*
 * Given array of integers sequence and some integer fixedElement, output the number of even values
 * in sequence before the first occurence of fixedElement or -1 if fixedElement is not contained in
 * sequence.
 * 
 * Example
 * 
 ...
 * 
 * [input] array.integer sequence non-empty array of positive integers
 * 
