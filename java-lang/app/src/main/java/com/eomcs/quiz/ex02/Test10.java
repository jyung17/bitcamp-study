...
//
/*
 * Lucky numbers are the positive integers whose decimal representations contain only the lucky
 * digits 4 and 7
 * 
 * [input] integer n a positive integer
 * 
 * [output] boolean true if n is a lucky number, false otherwise
 */
//
// [시간 복잡도]
// - ?
