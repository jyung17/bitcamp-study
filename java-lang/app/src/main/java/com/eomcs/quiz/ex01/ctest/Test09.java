 ...
 * 
 * [input] integer element1 1st element of the arithmetic progression
 * 
 * [input] integer element2 2nd element of the arithmetic progression
 * 
...
public class Test09 {
  ...
  static int arithmeticProgression(int element1, int element2, int n) {
    // 이 메서드를 완성하시오!
    int result = element2 + (element2 - element1);
    for (int i = 3; i < n; i++) {
      result = result + (element2 - element1);
    }
