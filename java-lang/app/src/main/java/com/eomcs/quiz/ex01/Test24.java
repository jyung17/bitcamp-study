...
//
/*
 * Given integers L and R, find the number of different pairs of integers A and B such that L <= A
 * <= R and L <= B <= R and A^3 = B^2.
 * 
 * Note that A and B may even coincide (A = B = 1 is one of the possibilities).
 * 
 * Example
 * 
 * for L=1, R=4 output should be 1 - (1,1) for L=1, R=8 output should be 2 - (1,1) and (4,8)
 * 
 * [input] integer L
 * 
 * [input] integer R
