 ...
 * Example
 * 
 * isInsideTheCircle(0, 0, 0, 0, 1) = true isInsideTheCircle(-1, -1, 0, 0, 1) = false
 * 
 * [input] integer xa x coordinate of the given point
 * 
 * [input] integer ya y coordinate of the given point
 * 
 * [input] integer xc x coordinate of the center of the circle
 * 
 * [input] integer yc y coordinate of the center of the circle
 * 
 * [input] integer rc the radius of the circle
 * 
 * [output] boolean
 * 
